...
Scout 0.5 is still pre-1.0. The stable specification should be frozen only when the grammar, parser, conversion behavior, formatter, conformance tests, recovery behavior, and editor tooling agree.
